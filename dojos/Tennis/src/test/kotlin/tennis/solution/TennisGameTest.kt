...
class TennisTest {
	...
	@MethodSource("allScoreCombinations")
	fun `Check All Score Combinations`(
		player1Score: Int,
		player2Score: Int,
		...
		game.determineScore() shouldBe expectedResult
	}

	companion object {

		@JvmStatic
		private fun allScoreCombinations(): Stream<Arguments> =
			Stream.of(
