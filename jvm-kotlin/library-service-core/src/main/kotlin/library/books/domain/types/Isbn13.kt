...
import library.books.domain.types.Isbn13.NotAnIsbnNumberException
import library.exceptions.MalformedValueException
...
data class Isbn13(
    ...
    companion object {
        ...
        private const val VALID_PARSE_PATTERN = """(\d{3}-?)?\d{10}"""
