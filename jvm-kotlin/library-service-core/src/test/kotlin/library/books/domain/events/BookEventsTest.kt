package library.books.domain.events
...
internal class BookEventsTest {
    ...
    @Test
    fun `all event types are unique`() {
    ...
    @TestFactory
    fun `all event types follow naming pattern`() = allBookEventTypes.map {
    ...
    @TestFactory
    fun `all event ids are formatted as strings`() = allBookEventTypes.map {
        dynamicTest(it.javaClass.simpleName) {
    ...
    @TestFactory
    fun `all event book ids are formatted as strings`() = allBookEventTypes.map {
        dynamicTest(it.javaClass.simpleName) {
    ...
    @TestFactory
    fun `all event timestamps are formatted as strings`() = allBookEventTypes.map {
        dynamicTest(it.javaClass.simpleName) {
    ...
    @TestFactory
    fun `all event book isbn are formatted as strings`() = allBookEventTypes.map {
        dynamicTest(it.javaClass.simpleName) {
    ...
    @TestFactory
    fun `all event book titles are formatted as strings`() = allBookEventTypes.map {
        dynamicTest(it.javaClass.simpleName) {
